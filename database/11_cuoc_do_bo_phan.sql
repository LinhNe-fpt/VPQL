...
-- Cấp cược đồ theo bộ phận: XUAT_CUOC_PB + SoNhanVienCap

IF COL_LENGTH('PhieuGiaoDich', 'SoNhanVienCap') IS NULL
    ALTER TABLE PhieuGiaoDich ADD SoNhanVienCap INT NULL;
GO
